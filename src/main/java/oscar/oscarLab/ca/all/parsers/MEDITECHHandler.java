...
//	public static final boolean USE_OBR_HEADERS_FOR_OBR_NAME = Boolean.TRUE; 
	...
	public String getDiscipline() {
		...
		headers = new ArrayList<String>( getHeaders() );
	...
	private void createProviderMap(XCN[] providerArray, HashMap<String, String> providerMap ) {
	...
	protected static String formatDateTime( String plain ){
		...
		return UtilDateUtilities.DateToString( UtilDateUtilities.StringToDate( plain, dateFormat ), stringFormat );
	}
