...
public class FrmDrawingToolRecord extends FrmRecord {
    ...
    public Properties getFormRecord(LoggedInInfo loggedInInfo, int demographicNo, int existingID)
        ...
        if(existingID <= 0) {
            ...
            String sql = "SELECT * FROM form_drawing_tool WHERE demographic_no = " +demographicNo +" AND id = " +existingID;
    ...
    public int saveFormRecord(Properties props)  throws SQLException  {
        ...
        String sql = "SELECT * FROM form_drawing_tool WHERE demographic_no = " +demographic_no +" AND id  = 0";
