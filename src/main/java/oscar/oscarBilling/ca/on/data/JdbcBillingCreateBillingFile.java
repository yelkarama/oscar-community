...
public class JdbcBillingCreateBillingFile {
	...
	private String buildSiteHTMLContentRecord(int invCount) {
		String ret = null;
		if (invCount == 0) {
			ret = "\n<tr><td class='myIvory'><a href=# onclick=\"popupPage(720,740,'../billing/CA/ON/billingONCorrection.jsp?billing_no=" + ch1Obj.getId() + "');return false;\">" + ch1Obj.getId() + "</a></td>" + "<td class='myIvory'><a href=# onclick=\"popupPage(720,740,'../demographic/demographiccontrol.jsp?demographic_no=" + ch1Obj.getDemographic_no() + "&displaymode=edit&dboperation=search_detail');return false;\">" + ch1Obj.getDemographic_name() + "</a></td><td class='myIvory'>" + ch1Obj.getHin()
