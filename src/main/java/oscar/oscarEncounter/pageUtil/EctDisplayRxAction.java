...
public class EctDisplayRxAction extends EctDisplayAction {
    ...
    public boolean getInfo(EctSessionBean bean, HttpServletRequest request, NavBarDisplayDAO Dao, MessageResources messages) {
        ...
        String leftUrl="popupPage(580,1027,'" + winName + "','" + request.getContextPath() + "/oscarRx/choosePatient.do?providerNo=" + bean.providerNo + "&demographicNo=" + bean.demographicNo + "&autoSaveOpenerOnOpen=true')";
        String url = "popupPage(580,1027,'" + winName + "','" + request.getContextPath() + "/oscarRx/choosePatient.do?providerNo=" + bean.providerNo +"&ltm=true"+ "&demographicNo=" + bean.demographicNo + "&autoSaveOpenerOnOpen=true')";
