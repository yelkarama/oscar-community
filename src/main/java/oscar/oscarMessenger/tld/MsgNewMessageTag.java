...
public class MsgNewMessageTag extends TagSupport {
    ...
    public int doStartTag() throws JspException    {
            ...
            try {
                ...
                String sql = "select count(*) from messagelisttbl m LEFT JOIN oscarcommlocations o ON m.remoteLocation = o.locationId where m.provider_no = ? and (m.status = 'new' or m.status = 'unread') and o.current1=1" ;
