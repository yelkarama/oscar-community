...
public class UserProperty extends AbstractModel<Integer> implements Serializable {
	...
	public static final String RX_DEFAULT_FULL_PRINT = "rx_default_full_print";
    ...
    public static final String ENHANCED_OR_CLASSIC = "enhanced_or_classic";
    ...
    public static final String DEFAULT_COVER_PAGE = "default_cover_page";
