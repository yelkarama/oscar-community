...
public class SystemPreferences extends AbstractModel<Integer>
{
    ...
    public static final List<String> ECHART_PREFERENCE_KEYS = Arrays.asList("echart_show_timer", "echart_email_indicator", "echart_show_fam_doc_widget", "echart_show_ref_doc_widget");
