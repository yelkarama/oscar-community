...
public class HL7A08Data
{
     ...
     * Constructor
     */
	public HL7A08Data(org.oscarehr.common.model.Demographic demograph) {
     ...
     */
    /*
	public HL7A08Data(oscar.oscarDemographic.data.DemographicData.Demographic demograph) {
		this.setDemographicData(demograph);
	}
	*/
     ...
     * Constructor
     */
	public HL7A08Data( org.oscarehr.common.model.Demographic demograph, ApptData appData, ClinicData clinicData, List programs) {
        this.setDemographicData(demograph);
     ...
     * Constructor
     */
	public HL7A08Data( org.oscarehr.common.model.Demographic demograph, ApptData appData, ClinicData clinicData) {
        this.setDemographicData(demograph);
        this.setAppData(appData);
        this.setClinicData(clinicData);
    }
     ...
     */
    /*
	public HL7A08Data( oscar.oscarDemographic.data.DemographicData.Demographic demograph, ApptData appData, ClinicData clinicData) throws HL7Exception {
        this.setDemographicData(demograph);
        this.setAppData(appData);
        this.setClinicData(clinicData);
    }
	...
	*/
    ...
    public boolean save() throws HL7Exception {
		if (this.message == null)
			this.generateA08MessageGuelph();
		       
        logger.info("Creating HL7 A08 file with contents: " + this.message);
        ...
        try {
			...
			logger.error("ERROR while saving HL7 A08 file: " + e.toString());
			return false;
        }
        
        logger.info("Successfully saved HL7 A08 file: " + saveDir + this.fileName);
	 ...
	 * 
	 */
	public String getA08Message() throws HL7Exception {
		if (this.message == null)
			this.generateA08MessageGuelph();
    ...
    /**
     * generateA08MessageGuelph
     * 
     * Generates the encoded HL7 A08 message specific for St. Joe's Guelph
     * @throws HL7Exception 
     */
	public void generateA08MessageGuelph() throws HL7Exception {
		if (this.demoData == null) {
			logger.error("ERROR while generating HL7 A08: Demographic data is null");
			throw new HL7Exception("Error generating HL7 A08: Demographic data is null");
		}
