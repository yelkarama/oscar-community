...
public class CxfClientUtils
{
	...
	private static void configureSsl(HTTPConduit httpConduit)
	{
		...
		tslClientParameters.setCipherSuites(java.util.Collections.singletonList("DHE-RSA-AES256-SHA256"));
//?no		tslClientParameters.setCipherSuites(java.util.Collections.singletonList("TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256"));
