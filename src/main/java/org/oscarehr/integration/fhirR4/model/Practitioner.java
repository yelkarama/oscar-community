...
import org.oscarehr.integration.fhirR4.exception.MandatoryAttributeException;
import org.oscarehr.integration.fhirR4.manager.OscarFhirConfigurationManager;
import org.oscarehr.util.MiscUtils;

public class Practitioner extends AbstractOscarFhirResource<org.hl7.fhir.r4.model.Practitioner, org.oscarehr.common.model.Provider> {
	 ...
	 * 
	 */
	protected void setIdentifier( org.hl7.fhir.r4.model.Practitioner fhirResource ) throws MandatoryAttributeException {
	...
	protected void setNurseIdentifier( org.hl7.fhir.r4.model.Practitioner fhirResource, String practitionerNumber ) {
		fhirResource.addIdentifier()
		.setSystem( DHIR.ID_SYSTEM_GLOBAL_BASE + "/ca-on-license-nurse" )
		.setValue( practitionerNumber );		
	}
	
	protected void setDoctorIdentifier( org.hl7.fhir.r4.model.Practitioner fhirResource, String practitionerNumber ) {
		fhirResource.addIdentifier()
		.setSystem( DHIR.ID_SYSTEM_GLOBAL_BASE + "/ca-on-license-physician" )
		.setValue( practitionerNumber );
	}
	
	protected void setPharmacistIdentifier( org.hl7.fhir.r4.model.Practitioner fhirResource, String practitionerNumber ) {
		fhirResource.addIdentifier()
		.setSystem( DHIR.ID_SYSTEM_GLOBAL_BASE  + "/ca-on-license-pharmacist" )
		.setValue( practitionerNumber );
	}
	
	protected void setMidwifeIdentifier( org.hl7.fhir.r4.model.Practitioner fhirResource, String practitionerNumber ) {
		fhirResource.addIdentifier()
