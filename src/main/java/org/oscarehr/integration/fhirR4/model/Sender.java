...
public class Sender {
	...
	public void setClinic( org.oscarehr.common.model.Clinic clinic,  OscarFhirConfigurationManager configurationManager ) {
		if(clinic != null) {
			setSenderName( clinic.getClinicName() );
	...
	public void setOscarFhirResource( AbstractOscarFhirResource<org.hl7.fhir.r4.model.Organization, Clinic> oscarFhirResource ) {
