...
import org.oscarehr.integration.fhirR4.model.Immunization;
import org.oscarehr.integration.fhirR4.model.AbstractOscarFhirResource;
import org.oscarehr.integration.fhirR4.model.PerformingPractitioner;
import org.oscarehr.integration.fhirR4.model.Practitioner;
import org.oscarehr.integration.fhirR4.resources.types.PublicHealthUnitType;
...
public class OscarFhirResourceManager {
	 ...
	 */
	public static final List< org.oscarehr.integration.fhirR4.model.Immunization<Prevention> > getImmunizationsByDemographicNo( OscarFhirConfigurationManager configurationManager, int demographicNo ) {
		...
		List< org.oscarehr.integration.fhirR4.model.Immunization<Prevention> > immunizations = null;
			...
			for( Prevention prevention : preventions ) {
				...
				if( prevention.isImmunization() ) {
					...
					if( immunizations == null ) {
						immunizations = new ArrayList< org.oscarehr.integration.fhirR4.model.Immunization<Prevention> >();							
					}
					org.oscarehr.integration.fhirR4.model.Immunization<Prevention> immunization = new org.oscarehr.integration.fhirR4.model.Immunization<Prevention>( prevention, configurationManager );
	 ...
	 */
	public static final org.oscarehr.integration.fhirR4.model.Immunization<Prevention> getImmunizationById( OscarFhirConfigurationManager configurationManager, int preventionId) {
		PreventionManager preventionManager = SpringUtils.getBean(PreventionManager.class);
		Prevention prevention = preventionManager.getPrevention(configurationManager.getLoggedInInfo(), preventionId);
	
		org.oscarehr.integration.fhirR4.model.Immunization<Prevention> immunization = null;

		if( prevention != null ) {
			LogAction.addLogSynchronous( configurationManager.getLoggedInInfo(), "OscarFhirResourceManager.getImmunizationsByDemographicNo", "Retrieved Immunization list for FHIR transport "  );
			immunization = new org.oscarehr.integration.fhirR4.model.Immunization<Prevention>( prevention, configurationManager );		
		}
	 ...
	 */
	public static final org.oscarehr.integration.fhirR4.model.Patient getPatientByDemographicNumber( OscarFhirConfigurationManager configurationManager, int demographic_no ) {
		...
		org.oscarehr.integration.fhirR4.model.Patient patient = null;
		
		if( demographic != null ) {
			patient = new org.oscarehr.integration.fhirR4.model.Patient( demographic, configurationManager );
	 ...
	 * @param hcn
	 * @param hcnType
	 * @return List<org.oscarehr.integration.fhirR4.model.Patient>
	 */
	public static final List<org.oscarehr.integration.fhirR4.model.Patient> getPatientsByPHN( OscarFhirConfigurationManager configurationManager, String hcn, String hcnType ) {
		DemographicManager demographicManager = SpringUtils.getBean(DemographicManager.class);
		...
		List<org.oscarehr.integration.fhirR4.model.Patient> patientList = null;
		...
		if( demographicList != null ) {
			...
			for( Demographic demographic : demographicList ) {
				...
				if( patientList == null ) {
					patientList = new ArrayList<org.oscarehr.integration.fhirR4.model.Patient>();
				}
				org.oscarehr.integration.fhirR4.model.Patient patient = new org.oscarehr.integration.fhirR4.model.Patient( demographic, configurationManager );
	...
	public static final org.oscarehr.integration.fhirR4.model.Practitioner getDemographicMostResponsiblePractitioner( OscarFhirConfigurationManager configurationManager, int demographic_no ) {
		DemographicManager demographicManager = SpringUtils.getBean(DemographicManager.class);
		Demographic demographic = demographicManager.getDemographic(configurationManager.getLoggedInInfo(), demographic_no);
	 ...
	 */
	public static final org.oscarehr.integration.fhirR4.model.PerformingPractitioner getPerformingPractitionerByProviderNumber( OscarFhirConfigurationManager configurationManager, String providerNo ) {
		...
		org.oscarehr.integration.fhirR4.model.PerformingPractitioner practitioner = null;
		
		if( provider != null ) {
			practitioner = new org.oscarehr.integration.fhirR4.model.PerformingPractitioner( provider, configurationManager );
	 ...
	 * @param configurationManager
	 * @param providerNo
	 * @return org.oscarehr.integration.fhirR4.model.Practitioner
	 */
	public static final org.oscarehr.integration.fhirR4.model.Practitioner getPractitionerByProviderNumber( OscarFhirConfigurationManager configurationManager, String providerNo ) {
		ProviderManager2 providerManager = SpringUtils.getBean(ProviderManager2.class);
		
		Provider provider = providerManager.getProvider( configurationManager.getLoggedInInfo(), providerNo );
		org.oscarehr.integration.fhirR4.model.Practitioner practitioner = null;
		
		if( provider != null ) {
			practitioner = new org.oscarehr.integration.fhirR4.model.Practitioner( provider, configurationManager );
			LogAction.addLogSynchronous( configurationManager.getLoggedInInfo(), "OscarFhirResourceManager.getProviderByProviderNumber", "Retrieved provider " + providerNo + " " + provider.toString() );
		}
	 ...
	 */
	public static final HashSet<AbstractOscarFhirResource<?,?>> getImmunizationResourceBundle( OscarFhirConfigurationManager configurationManager, org.oscarehr.integration.fhirR4.model.Patient patient, HashSet<AbstractOscarFhirResource<?,?>> resourceList ) {
		
		List< org.oscarehr.integration.fhirR4.model.Immunization<Prevention> > immunizations = OscarFhirResourceManager.getImmunizationsByDemographicNo( configurationManager, patient.getOscarResource().getDemographicNo() );
		if( immunizations != null ) {
	 ...
	 */
	public static final org.hl7.fhir.r4.model.Organization getPublicHealthUnit( OscarFhirConfigurationManager configurationManager, int demographicNo ) {
	...
	private static final HashSet<AbstractOscarFhirResource<?,?>> linkPerformingPractitionerAndPatient( 
			OscarFhirConfigurationManager configurationManager, 
			List<org.oscarehr.integration.fhirR4.model.Immunization<Prevention>> immunizations, 
			org.oscarehr.integration.fhirR4.model.Patient patient, HashSet<AbstractOscarFhirResource<?,?>> resourceList ) {
