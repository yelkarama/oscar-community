...
<%   } %>
		...
		<td><input type="button" name="Select" value="Select" class="btn btn-primary" style="margin-bottom:10px;" onclick="window.opener.setType(typeSel,reasonSel,locSel,durSel,notesSel,resSel); window.close()">
