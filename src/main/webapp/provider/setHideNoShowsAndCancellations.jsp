<%--
    ...
    Copyright (c) 2015-2016. KAI Innovations Inc. All Rights Reserved.
...
<table class="MainTable" id="scrollNumber1" name="encounterTable">
	...
	<tr>
		...
		<%if( request.getAttribute("status") == null ){%> 
			<bean-el:message key="${providermsgEdit}" /> <c:out value="${hideNoShowsAndCancellationsProperty.value}" /> 
			<html:form action="/setProviderStaleDate.do">
				<input type="hidden" name="method" value="<c:out value="${method}"/>">	
                <html:select property="hideNoShowsAndCancellationsProperty.value">
    	            <html:option value="">None</html:option>
    	            <html:option value="${noShows}">No Shows</html:option>
    	            <html:option value="${cancellations}">Cancellations</html:option>
