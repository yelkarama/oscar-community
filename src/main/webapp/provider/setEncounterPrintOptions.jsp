        ...
        <tr>
            ...
            <td class="MainTableRightColumn">
                ...
                <html:form action="/setProviderStaleDate.do">
                    ...
                    <html:select property="printOp.value">
                        <html:options collection="dropOpts" property="value"
                                      labelProperty="label" />
                    </html:select> <br/>
                    <html:checkbox property="printCPP.checked"/> CPP
                    <br/>
                    <html:checkbox property="printRx.checked"/> Rx
                    <br/>
                    <html:checkbox property="printLabs.checked"/> Labs
                    <br/>
