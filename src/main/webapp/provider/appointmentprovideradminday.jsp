...
function ts1(s) {
popupPage(600,800,('../appointment/addappointment.jsp?'+s));
}
function tsr(s) {
popupPage(600,800,('../appointment/appointmentcontrol.jsp?displaymode=edit&dboperation=search&'+s));
}
