...
<caisi:isModuleLoad moduleName="caisi" reverse="true">
	<%
            ...
            String appointmentReason = request.getParameter("reason") != null ? URLEncoder.encode(request.getParameter("reason"), "UTF-8") : "";
            String hrefurl=request.getContextPath()+"/casemgmt/forward.jsp?action=view&demographicNo="+bean.demographicNo+"&providerNo="+bean.providerNo+"&providerName="+URLEncoder.encode(bean.userName, "UTF-8")+"&appointmentNo="+request.getParameter("appointmentNo")+"&reason=" + appointmentReason + "&appointmentDate="+request.getParameter("appointmentDate")+"&start_time="+request.getParameter("startTime")+ "&apptProvider=" + request.getParameter("apptProvider_no")+"&providerview="+ request.getParameter("providerview") +
