...
%>
	...
	class="myIvory">
		<trclass="myYellow">
			<thwidth="6%">Provider</th>
			<thwidth="8%">Claims</th>
			<thwidth="7%" align=right>Invoiced</th>
			<th width="7%" align=right>Paid</th>
			<thwidth="7%" align=right>Clinic Pay</th>
			<thwidth="7%" align=right>Hospital Pay</th>
			<thwidth="7%" align=right>OB</th>
...
%>
	<tr <%=color %>>
		<td align="center"><a href="onGenRAProvider.jsp?proNo=<%=prop.getProperty("providerohip_no", "&nbsp;")%>&rano=<%=raNo%>&submit=Generate">
			...
			<tdalign="center"><%=prop.getProperty("claims" , "&nbsp;")%></td>
