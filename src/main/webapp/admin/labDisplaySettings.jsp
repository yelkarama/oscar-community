...
<%
    ...
    String key = SystemPreferences.LAB_DISPLAY_PREFERENCE_KEYS;
...
<script src="<%=request.getContextPath()%>/JavaScriptServlet" type="text/javascript"></script>
    ...
    <form name="labDisplaySettingsForm" method="post" action="labDisplaySettings.jsp">
        ...
        <input type="button" onclick="document.forms['labDisplaySettingsForm'].dboperation.value='Save'; document.forms['labDisplaySettingsForm'].submit();" name="saveLabDisplaySettings" value="Save"/>
    </form>
    </body>
</html:html>