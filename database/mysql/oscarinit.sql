...
--
-- Table structure for table `billing_permission`
--
...
CREATE TABLE raheader (
  ...
  group_no varchar(4) NOT NULL default '',
...
CREATE TABLE alert_dismissal (
  ...
  provider_no VARCHAR(6)  NOT NULL,
  dismiss_date DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (alert_id, provider_no)
);
